...
path = "C:/Users/Renato/OneDrive/Ambiente de Trabalho/stereo_calib/"
...
for imgLeft, imgRight in zip(imagesLeft, imagesRight):
    ...
    if retL and retR:
        ...
        cv.imshow('img left', cv.resize(imgL, (800, 500)))
        cv.drawChessboardCorners(imgR, chessboardSize, cornersR, retR)
        cv.imshow('img right', cv.resize(imgR, (800, 500)))
        cv.waitKey(1000)
...
cv_file = cv.FileStorage('Results\stereoMap.xml', cv.FILE_STORAGE_WRITE)
