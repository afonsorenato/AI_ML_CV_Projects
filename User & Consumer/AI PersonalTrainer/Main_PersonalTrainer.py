...
import math
import os
from Functions import trainMenu
...
# Gets the user's hands landmarks
...
# Estimates the angle between two limbs
...
# Evaluates if the movement was a squat
...
# Evaluates of the movement was a leg Raise
...
min_to_enter = 80
accept_squats = accept_legs = accept_push = 0
